...
namespace Moonshot.Sprites
{
    public class Sprite : GameEntity, ICloneable
    {
        ...
        public override List<Sprite> Children { get; set; }
        ...
        /// <summary>
        ///  Per-pixel collision detection (doesn't work with animated sprites (currently))
        /// </summary>
        /// <param name="sprite"></param>
        /// <returns></returns>
        public bool Intersects(Sprite sprite)
        {
            if (this.TextureData == null) // doesn't work on animated sprites
                return false;
        ...
        public object Clone()
        {
            ...
            if (_animations != null)
            {
                sprite._animations = this._animations.ToDictionary(c => c.Key, v => v.Value.Clone() as Animation); // deeper clone on animations
                sprite._animationManager = sprite._animationManager.Clone() as AnimationManager; // and AnimationManager
            }
